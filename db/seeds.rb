...
Skill.create(name: 'Read And Write', fighter: 6, scout: 6, rogue: 6, adept: 3, scholar: 3, templar: 3, artisan: 3, skill_type: 'bol', group: 'other')
Skill.create(name: 'Read Magic', fighter: 8, scout: 8, rogue: 6, adept: 4, scholar: 4, templar: 4, artisan: 6, skill_type: 'bol', group: 'other')
Skill.create(name: 'First Aid', fighter: 2, scout: 2, rogue: 2, adept: 2, scholar: 2, templar: 2, artisan: 2, skill_type: 'bol', group: 'other')
Skill.create(name: 'Healing Arts', fighter: 6, scout: 6, rogue: 4, adept: 2, scholar: 2, templar: 2, artisan: 4, skill_type: 'bol', group: 'other')
